...
import { useCompanyInfo, useTeamMembers } from "@/hooks/useLocalizedConstants";
...
const TeamsPage = () => {
  ...
  return (
    <>
      <Helmet>
        <title>Our Team | {companyInfo.name}</title>
        <meta name="description" content={t("teams_meta_description")} />
      </Helmet>
      ...
      <section className="py-16 bg-white">
        <div className="container px-4">
          ...
          >
            ...
            <motion.div
              className="grid md:grid-cols-2 lg:grid-cols-3 xl:grid-cols-5 gap-6 md:gap-8 max-w-7xl mx-auto"
              variants={{
                hidden: { opacity: 0 },
                visible: {
                  opacity: 1,
                        ...
                        <div className="flex gap-3 mt-2">
                          {member.social.linkedin && (
                            <a
                              ...
                              className="text-gray-500 hover:text-brand-blue transition-colors social-link"
